...
struct ChartView: View {
    ...
    @State private var percentange: CGFloat = 0
    ...
    init(coin: Coin) {
        ...
        endingDate = .init(coinGakoString: coin.lastUpdated.removeOptional())
...
extension ChartView {
    ...
    @ViewBuilder
    private var chartYView: some View {
        VStack {
